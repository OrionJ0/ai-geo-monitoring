...
module.exports = {
  async up({ queryInterface, transaction }) {
    await queryInterface.createTable('baidu_tongji_range_snapshots', {
    ...
    await queryInterface.addIndex(
      ...
      {
        name: 'baidu_tongji_range_snapshots_scope',
        unique: true,
        transaction
      }
    );
    await queryInterface.addIndex(
      'baidu_tongji_range_snapshots',
      ['expires_at'],
      { name: 'baidu_tongji_range_snapshots_expiry', transaction }
    );
  }
};
