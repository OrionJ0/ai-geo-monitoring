...
const WEB_RUNTIME_STATUS_PATHS = Object.freeze(new Set([
  '/ai-platforms/deepseek-web/runtime-status',
  '/ai-platforms/doubao-web/runtime-status'
]));
...
function shouldSkipGeneralLimiter(pathname) {
  ...
  return WEB_RUNTIME_STATUS_PATHS.has(path)
