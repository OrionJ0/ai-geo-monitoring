...
| [百度 Provider 模块化重构](active-2026-08-05-005-baidu-provider-modularization/prd.md) | Issues 001–004 已关闭：等价基线、唯一安全 HTTP 内核、OAuth、搜索推广与百度统计客户端已完成，facade 旧产品实现已清理且未发布；当前进入 Issue 005 对抗式审查、正式硬切与公开入口验收 |
