...
| [营销工作线主分支集成与治理收尾](active-2026-08-06-008-marketing-main-integration-closeout/prd.md) | 003→006→007→005 已安全重放到最新 main 候选且 Flash 零改写；四接口实际响应 OpenAPI 2020-12 校验已关闭，正在处理关键词上期汇总复用、报告端点唯一真值和最终 main/生产 revision 对齐 |
