...
| [百度 Provider 模块化重构](active-2026-08-05-005-baidu-provider-modularization/prd.md) | Issue 001 已关闭：旧单体的 facade、脱敏 trace、预算、错误与 007 修正行为已冻结；当前进入 Issue 002 抽取唯一安全 HTTP 内核与 OAuth 客户端，中间状态不发布 |
