...
| [Flash 结构化分析可靠性](active-2026-08-05-002-flash-structured-analysis-reliability/prd.md) | 001–008 已完成；009 不批准硬切；011 目标映射歧义隔离已完成并关闭（S55 真实 Flash 3/3 保留目标事实）；012 `semantic_evidence_v2` 双角色证据合同已完成并关闭（`three_track_partial_v2`，S43 真实 Flash 3/3 目标语义 complete）；013 评测合同 P0/P1 返工完成但仍 blocked：全局确认泄漏、关系假门禁、canonicalization 恒 100%、loader 不 fail-closed 已修复，truth v3 模板（55 条 pending_review）与 manifest 已生成，剩余等待人工裁决盲审分歧（见 TRUTH-REVIEW-QUEUE.md）。014/015 未启动，010 保持阻塞。正式入口仍走 v4，当前 DeepSeek 默认分析配置为 Pro；v5 显式候选固定 Flash。 |
