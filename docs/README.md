...
| [百度统一 OAuth 凭据与营销 API 架构](active-2026-08-05-003-baidu-unified-oauth-api-architecture/prd.md) | 正在执行 Issue 001 无状态只读探针；当前正式路径仍使用 OAuth 与百度统计 Data API 两套凭据，尚未切换、迁移或退役旧实现 |
