...
> 2026-07-30 抓取安全更新：正式入口已增加响应可信度分类、WAF/429 任务内止损、有界预检和 resolved URL 去重；完整当前合同与验收见 `../closed-2026-07-30-001-seo-audit-response-safety/`。2026-07-31 根据真实站点 1 页任务仍耗时 111.2 秒的基线，将无风控任务调整为页面并发 4、同域 250ms 间隔，并让 Sitemap 递归和站内链接探活受实际页面范围约束；站外链接退出全站主请求链路。
