...
2. 调用设置页选定的分析平台和模型。
3. 对 DeepSeek 开启高强度思考，并使用 JSON mode。
...
- 独立临时数据库的真实 HTTP 设置入口返回 v4、DeepSeek Pro、JSON mode、高强度思考、120 秒超时、最多 2 次尝试、关闭 Web 搜索和无应用层 Token 上限；真实 DeepSeek Pro 主基线 40/40、补充情绪边界集 12/12 分析成功。
